...
export default async function AdminPage() {
  ...
  return (
    <main className="space-y-8">
      <PageHeader
        title="Admin Panel"
        subtitle="Manage users, announcements, and company data from one place."
        action={
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard label="Posts" value={postsCount ?? 0} />
        <StatCard label="Tasks" value={tasksCount ?? 0} tone="soft" />
        <StatCard
          label="Events / Chats"
